...
*/
	...
	public static void returnCamcorder(ArrayList<Camcorder> camcorderList) {
	  ...
	  // write your doReturnChromebook code here public static boolean
	public static boolean  doReturnChromebook(ArrayList<Chromebook> chromebookList, String tag) {
	  ...
	  if (tag.equalsIgnoreCase(assetTag) && chromebookList.get(i).getIsAvailable()
	  == false) {
	  ...
	  // write your code here ResourceCentre.viewAllChromebook(chromebookList);
	  String tag = Helper.readString("Enter asset tag > ");
	  Boolean isReturned =
	...
	public static Object showAvailability(boolean isAvailable, String dueDate) {
